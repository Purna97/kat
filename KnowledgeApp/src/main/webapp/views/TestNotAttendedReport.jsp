						...
						<div class="row">
							<div class="col-lg-12">
								<div class="well bs-component">
									<fieldset>
										<!-- <legend>Non Attended </legend> -->
										<form action="generateAssessmentReport">
											...
											<div class="form-group">
												<div class="col-lg-6 col-lg-offset-1">
													<!-- <button type="button" value="Get Report" class="btn btn-primary" onclick="showGrid();">Generate</button> -->
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						...
						<center>
							<a onclick="return validate();" href="downloadNonAttTestReport"
			...
			<div class="row" style="display: none">
				<div class="col-lg-12">
					<div class="alert alert-info">
						<strong>Total Pass:${totalCount}</strong> <
...
function showGrid(){
    ...
    $.ajax({
        ...
        success  : function(response){
        	alert("success");
        	 reportdtoList=response.notAttendedDto;
        	 document.getElementById("tablegrid").display="block";
            ...
            '<td>'+reportdtoList[i].status+'</td></tr>';
            $("#tableview").append(tr);
            }
